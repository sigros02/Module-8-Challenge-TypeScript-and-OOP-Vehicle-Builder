...
class Cli {
    ...
    createTruck() {
        inquirer
            ...
            Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [], answers.towingCapacity);
